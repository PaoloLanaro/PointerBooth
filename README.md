...
It contains compatibility of STBI image filters to OpenCV matrix image formats. This allows effects like "Pointillism"
implemented on STBI data to be implemented in OpenCV video.
...
configurations, and the STBI library is used for image manipulation.
